    ...
    return (
        <>
            <div className="relative h-screen w-full">
                ...
                <div className="relative z-10 flex min-h-screen flex-col items-center p-6 text-[#1b1b18] lg:justify-center lg:p-8">
                        ...
                        <nav className="flex items-center justify-end gap-4">
                            {auth.user && user.user_type === 'admin' ? (
                                ...
                                <>
                                    <Link
                                        href={route('login')}
                                        className="inline-block rounded-sm border border-transparent px-5 py-1.5 text-lg leading-normal text-[#1b1b18] hover:border-[#19140035]"
                                    >
                                        Log in
                                    </Link>
                                    <Link
                                        href={route('register')}
                                        className="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-lg leading-normal text-[#1b1b18] hover:border-[#1915014a]"
                                    >
                                        Register
                                    </Link>
                                </>
